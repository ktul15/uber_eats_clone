...
mixin _$UserProfileDto {
 ...
 String get id; String get email; String? get phone; String get role; CustomerProfileDto get profile;
...
@override
String toString() {
  return 'UserProfileDto(id: $id, email: $email, phone: $phone, role: $role, profile: $profile)';
}
...
@useResult
$Res call({
 String id, String email, String? phone, String role, CustomerProfileDto profile
});


$CustomerProfileDtoCopyWith<$Res> get profile;
...
$CustomerProfileDtoCopyWith<$Res> get profile {
  ...
  return $CustomerProfileDtoCopyWith<$Res>(_self.profile, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String? phone,  String role,  CustomerProfileDto profile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfileDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String? phone,  String role,  CustomerProfileDto profile)  $default,) {final _that = this;
switch (_that) {
case _UserProfileDto():
return $default(_that.id,_that.email,_that.phone,_that.role,_that.profile);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String? phone,  String role,  CustomerProfileDto profile)?  $default,) {final _that = this;
switch (_that) {
case _UserProfileDto() when $default != null:
return $default(_that.id,_that.email,_that.phone,_that.role,_that.profile);case _:
  return null;
...
class _UserProfileDto implements UserProfileDto {
  const _UserProfileDto({required this.id, required this.email, this.phone, required this.role, required this.profile});
...
@override final  CustomerProfileDto profile;
...
@override $CustomerProfileDtoCopyWith<$Res> get profile;
