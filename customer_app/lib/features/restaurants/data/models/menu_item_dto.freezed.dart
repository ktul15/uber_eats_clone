...
@override
String toString() {
  return 'MenuItemDto(id: $id, restaurantId: $restaurantId, name: $name, description: $description, price: $price, imageUrl: $imageUrl, isAvailable: $isAvailable)';
}
...
class _MenuItemDto implements MenuItemDto {
  const _MenuItemDto({required this.id, required this.restaurantId, required this.name, this.description, required this.price, this.imageUrl, required this.isAvailable});
