...
mixin _$OrderItemDto {
 ...
 String get id; String get orderId; String get menuItemId; int get quantity;@JsonKey(fromJson: doubleFromJson) double get priceAtTime; OrderItemMenuItemDto get menuItem;
...
@useResult
$Res call({
 String id, String orderId, String menuItemId, int quantity,@JsonKey(fromJson: doubleFromJson) double priceAtTime, OrderItemMenuItemDto menuItem
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String orderId,  String menuItemId,  int quantity, @JsonKey(fromJson: doubleFromJson)  double priceAtTime,  OrderItemMenuItemDto menuItem)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItemDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String orderId,  String menuItemId,  int quantity, @JsonKey(fromJson: doubleFromJson)  double priceAtTime,  OrderItemMenuItemDto menuItem)  $default,) {final _that = this;
switch (_that) {
case _OrderItemDto():
return $default(_that.id,_that.orderId,_that.menuItemId,_that.quantity,_that.priceAtTime,_that.menuItem);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String orderId,  String menuItemId,  int quantity, @JsonKey(fromJson: doubleFromJson)  double priceAtTime,  OrderItemMenuItemDto menuItem)?  $default,) {final _that = this;
switch (_that) {
case _OrderItemDto() when $default != null:
return $default(_that.id,_that.orderId,_that.menuItemId,_that.quantity,_that.priceAtTime,_that.menuItem);case _:
  return null;
...
class _OrderItemDto implements OrderItemDto {
  const _OrderItemDto({required this.id, required this.orderId, required this.menuItemId, required this.quantity, @JsonKey(fromJson: doubleFromJson) required this.priceAtTime, required this.menuItem});
...
@override@JsonKey(fromJson: doubleFromJson) final  double priceAtTime;
